...
These network effects "prime" diverse cellular processes to be comutated or more important for the tumor.

The different mutant forms of \kras{} demonstrate distinct kinetic properties regarding GTP hydrolysis and GDP exchange \cite{}, further complicated by the various preferences of the alleles to interact with GAPs and GEFs.
For instance, the \kras{} G12C allele has a higher intrinsic rate of GTP hydrolysis than the other common G12 and G13 alleles, though in the presence of P120GAP, the alleles had more similar rates, with G12A, G12D, and G13D all showing higher rates than G12C.
Further, our lab recently demonstrated the A146T mutant had a higher rate of exchange of GDP and acceptance of GTP than both WT \kras{} and the G12D mutant.
This mutant form also had a greater response to interactions with the GEF SOS1 compared to the two other proteins.

Distinctions in the immediate signaling behavior of the common mutant alleles have been discovered.
% "The Functional Proximal Proteome of Oncogenic Ras Includes mTORC2."
% see PQE

% We found evidence for the first part in the clustering of genes with \KRAS{} allele-specific interactions within the immediate neighborhood of \kras{} in the PPIN. 
% …
...
% Example: G12R and pinocytosis
% Example: (Poulin et al.) isogenic background --> different signaling in G12D vs. A146T
