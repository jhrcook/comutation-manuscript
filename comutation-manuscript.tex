...
This result suggested that the biological properties of the \KRAS{} alleles, within the context of the tissue of origin and tumor microenvironment, was an important factor in the positive selection of the \KRAS{} mutations over the evolution of a tumor.
...
On the other hand, some genes comutated with a \KRAS{} allele less frequently than expected by random chance, suggesting they are either functionally redundant or introduced an inhibitory effect on the tumor's progression.
Finally, functional interactions were identified between specific \KRAS{} alleles and cellular processes and individual genes.
...
The current study employed mutational signatures to estimate the frequency of \KRAS{} mutations under the null hypothesis that the \KRAS{} alleles were functionally equivalent and demonstrated that even this more nuanced model of random distribution of mutations was unable to explain the distribution of \KRAS{} alleles across the four cancers studied.
While this use of mutational signatures is not without precedent \cite{Dietlein2020IdentificationContext., Bergstrom2020GeneratingSigProfilerSimulator}, it has limitations, primarily in the assumption that the mutational signatures can completely describe the mutagenic forces acting on the genome.
This constraint was mitigated by the fact that the signatures were extracted from single base substitutions, just like the ones that caused the \KRAS{} allele.
...
Thus, it is not clear that including these data would add clarification to this study or the additional complexity would make the results more difficult to resolve.
