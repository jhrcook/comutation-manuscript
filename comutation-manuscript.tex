...
This result suggested that the biological properties of the \KRAS{} alleles, within the context of the tissue of origin and tumor microenvironment, is an important factor in the positive selection of a \KRAS{} mutation during the evolution of a tumor.
...
On the other hand, some genes comutated with a \KRAS{} allele less frequently than expected by random chance, suggesting they are either functionally redundant mutations or introduced an inhibitory effect on the tumor's progression.
...
The current study employed mutational signatures to estimate the frequency of \KRAS{} mutations under the null hypothesis that the \KRAS{} alleles were functionally equivalent and demonstrated that even this more nuanced model of the random distribution of mutations was unable to explain the distribution of \KRAS{} alleles across the four cancers studied.
...
The analysis of a genome-wide, CRISPR-Cas9, loss-of-function screen of 89 human COAD, LUAD, and PAAD cell lines revealed cellular processes and individual genes with differential degrees of essentiality associated with the \KRAS{} allele of the cell line.
The goal of this analysis was to identify potential allele-specific drug targets, progressing the concept of precision medicine to incorporate the \KRAS{} mutation of a patient's tumor.
The next step will be to reproduce these findings \emph{in vitro} in the original and new cell lines.
Further, the targets can be validated in more biologically relevant systems such as organoid or mouse models.
...
Presented here is a relatively brief analysis of the integrated results from the comutation and dependency analyses.
Specifically, we focused on the interaction between \KRAS{} G12C and \emph{STK11} because of the previously documented importance of this tumor suppressor, but it is just one instance of the greater pattern of slight variations to the oncogenic properties of mutant \KRAS{} having far reaching effects.
...
For instance, \kras{} G12C exhibited a higher intrinsic rate of GTP hydrolysis than the other common G12 and G13 alleles, though in the presence of P120GAP, the alleles had more similar rates, with \kras{} G12A, G12D, and G13D all showing higher rates than G12C \cite{Hunter2015a}.
Further, our lab recently demonstrated the A146T mutant had a higher rate of exchange of GDP for GTP than both WT \kras{} and the G12D mutant \cite{Poulin2019}.
This mutant form also had a greater response to interactions with the GEF SOS1 compared to the two other proteins.
Recent identification of maintained interactions between \kras{} G13D and the GAP NF-1 has been proposed as an explanation for continued sensitivity of \KRAS{} G13D-mutant tumors to anti-EGFR treatment \cite{McFall2019, Rabara2019, Zafra2019}.
...
Further, expression of G12C mutant \kras{} results in greater phospho-ERK compared to G12D or G12V \cite{Li2018AssessingCancer.}.
There are additional examples of the \kras{} mutant proteins having different binding preferences.
...
Also, LUAD cell lines expressing \kras{} G12D demonstrated increased activation of Akt via phosphorylation at T308 and S473, while \kras{} G12C indicated greater levels of interaction with RalA and RalB.
Other physical properties of \kras{}, such as dimerization, nanoclustering, and interactions with the cell membrane, have yet to be studied in an allele-specific way, though further distinctions may be found.

We also found evidence for the different local effects of the various \kras{} mutants represented by the clusters of \KRAS{} allele-specific interactions within the immediate neighborhood of \kras{} in the PPIN (Fig \ref{fig:results-integration-main}d).
Thus, there is strong evidence that the different oncogenic \kras{} forms perturb the local signaling network in nuanced, yet distinct, ways.
...
This study demonstrated that the elucidation of there interactions is possible by analyzing comutation with other genes and differential genetic dependency.
Another possible investigatory mechanism has been to examine survival data.
...
The reduced efficacy of these DNA crosslinking drugs was later linked to increased activity of base excision repair (BER) clearing the initial binding event before a second could form \cite{Caiola2015BaseCells.}.
...
Another approach that has been used to identify large-scale distinctions between \KRAS{} alleles is to create the alleles in otherwise isogenic model systems and measuring the effects experimentally.
Using this approach, Hobbs \emph{et al.} demonstrated that PAAD cell lines were all dependent upon macropinocytosis and that this process was dependent upon \KRAS{} expression, but only for only G12D and G12V mutant \KRAS{}, not G12R.
...
More nuanced differences were also uncovered including that though ERK2 was activated by both \kras{} G12D and \kras{} A146T, the specific targets were strikingly different.
This lends further support for the hypothesis that different oncogenic \KRAS{} alleles can have substantial effects on signaling processes throughout the cell.
...
% PMID: 29945997 -- TP53 comutation made a big difference in drug response at the end of the paper.
% \cite{Bournet2016} -- G12D tends to comutate with XX, this may be the determining factor.
